...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  x -> SList que representa o Dict com a traduçao a ser inserida}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment Bool -> se o Dict com a mesma primeira letra ou a mesma traducao ja foi encontrada }{}\<[E]%
\\
