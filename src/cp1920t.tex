...
\column{23}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{x}\mathrel{=}\Conid{Fork}\;(\Conid{Leaf}\;\text{\tt \char34 Precisa\char34},\Conid{Fork}\;(\Conid{Leaf}\;\text{\tt \char34 Precisa\char34},\Conid{Leaf}\;\text{\tt \char34 N~precisa\char34})){}\<[E]%
\\
