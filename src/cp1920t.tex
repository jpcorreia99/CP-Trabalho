...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{nothing}}{\cdot }\mathbin{\$}\Varid{\Conid{Cp}.ap}\comp \conj{\Varid{maybe}\;(\Varid{return}\comp \p1)\;\underline{(\p1\comp \p2)}\comp \p2\comp \p2}{\Varid{id}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
