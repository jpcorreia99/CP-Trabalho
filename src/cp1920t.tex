...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g}\;(\Conid{Just}\;(\Conid{Term}\;\Varid{a}\;\Varid{b}),\Conid{Term}\;\Varid{o}\;\Varid{l})\mid (\Varid{o}\equiv [\mskip1.5mu \mskip1.5mu]\mathrel{\vee}\Varid{o}\equiv \text{\ttfamily \char34 ~\char34})\mathrel{=}\Varid{recExp}\;\conj{\underline{(\Conid{Just}\;(\Conid{Term}\;\Varid{a}\;\Varid{b}))}}{\Varid{id}}\;{}\<[108]%
\>[108]{}(\Varid{outExp}\;(\Conid{Term}\;\Varid{o}\;(\Varid{insertIfAbsent}\;(\Conid{Term}\;\Varid{a}\;\Varid{b},\Varid{l})))){}\<[E]%
\\
\>[9]{}\hsindent{5}{}\<[14]%
