...
\\[\blanklineskip]%
\>[B]{}\mathbf{data}\;\Conid{SList}\;\Varid{a}\;\Varid{b}\mathrel{=}\Conid{Stl}\;\Varid{b}\mid \Conid{Cons}\;\Varid{a}\;(\Conid{SList}\;\Varid{a}\;\Varid{b})\;\mathbf{deriving}\;\Conid{Show}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inSList}\mathrel{=}\alt{\Conid{Stl}}{\uncurry{\Conid{Cons}}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outSList}\;(\Conid{Stl}\;\Varid{b}){}\<[23]%
\>[23]{}\mathrel{=}i_1\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{outSList}\;(\Conid{Cons}\;\Varid{a}\;\Varid{s})\mathrel{=}i_2\;(\Varid{a},\Varid{s}){}\<[E]%
\\
\>[B]{}\Varid{baseSList}\;\Varid{z}\;\Varid{x}\;\Varid{y}\mathrel{=}\Varid{z}+\Varid{x}\times\Varid{y}{}\<[E]%
\\
\>[B]{}\Varid{recSList}\;\Varid{f}\mathrel{=}\Varid{baseSList}\;\Varid{id}\;\Varid{id}\;\Varid{f}{}\<[E]%
\\
...
\\
\>[B]{}\Varid{dic\char95 in}\;\Varid{p}\;\Varid{t}\;\Varid{d}\mathrel{=}\Varid{hyloExp}\;\Varid{conquer}\;\Varid{divide}\;(\Conid{Just}\;(\Varid{traductionToSList}\;(\Varid{p},\Varid{t})),\Varid{d})\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{conquer}\mathrel{=}\Varid{inExp}\comp \alt{\Varid{outExp}}{i_2}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{divide}\;(\Conid{Nothing},\Varid{g})\mathrel{=}i_1\;(\Varid{g}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{divide}\;(\anonymous ,\Conid{Var}\;\Varid{l})\mathrel{=}i_1\;(\Conid{Var}\;\Varid{l}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{divide}\;(\Conid{Just}\;(\Conid{Cons}\;\Varid{x}\;\Varid{xs}),\Conid{Term}\;\Varid{o}\;\Varid{l})\mid (\Varid{o}\equiv [\mskip1.5mu \mskip1.5mu])\mathrel{=}{}\<[55]%
\>[55]{}i_2\mathbin{\$}(\Varid{o},\Varid{divide\char95 aux}\;(\Conid{Cons}\;\Varid{x}\;\Varid{xs})\;(\Conid{False},\Varid{l})){}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\mid (\Varid{x}\equiv \Varid{head}\;\Varid{o})\mathrel{=}i_2\mathbin{\$}(\Varid{o},\Varid{divide\char95 aux}\;\Varid{xs}\;(\Conid{False},\Varid{l})){}\<[E]%
\\
\>[11]{}\hsindent{30}{}\<[41]%
\>[41]{}\mid \Varid{otherwise}\mathrel{=}i_1\;(\Conid{Term}\;\Varid{o}\;\Varid{l}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{traductionToSList}\mathbin{::}(\Conid{String},\Conid{String})\to \Conid{SList}\;\Conid{Char}\;\Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{traductionToSList}\mathrel{=}\Varid{anaSList}\;\Varid{g}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;([\mskip1.5mu \mskip1.5mu],\Varid{t})\mathrel{=}i_1\;(\Varid{t});{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\;(\Varid{p}\mathbin{:}\Varid{ps},\Varid{t})\mathrel{=}i_2\;(\Varid{p},(\Varid{ps},\Varid{t})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{divide\char95 aux}\mathbin{::}(\Conid{SList}\;\Conid{Char}\;\Conid{String})\to (\Conid{Bool},[\mskip1.5mu \Conid{Dict}\mskip1.5mu])\to [\mskip1.5mu (\Conid{Maybe}\;(\Conid{SList}\;\Conid{Char}\;\Conid{String}),\Conid{Dict})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{divide\char95 aux}\;\Varid{x}\;(\Varid{bool},[\mskip1.5mu \mskip1.5mu])\mathrel{=}\mathbf{if}\;(\neg \;\Varid{bool}){}\<[E]%
\\
\>[B]{}\hsindent{26}{}\<[26]%
\>[26]{}\mathbf{then}\;\Varid{singl}\comp \conj{\Conid{Just}\comp \underline{\Varid{x}}}{\Varid{id}}\comp \alt{\Conid{Var}}{\uncurry{\Conid{Term}}\comp (\Varid{singl}\times\underline{[\mskip1.5mu \mskip1.5mu]})}\mathbin{\$}\Varid{outSList}\;\Varid{x}{}\<[E]%
\\
\>[B]{}\hsindent{26}{}\<[26]%
...
\>[44]{}\alt{\Varid{v}\equiv }{\Varid{false}}\mathbin{\$}\Varid{outSList}\;\Varid{x}{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{37}{}\<[37]%
\>[37]{}\mid (\neg \;\Varid{bool}\mathrel{\wedge}(\alt{\Varid{false}}{(\equiv \Varid{head}\;\Varid{o})\comp \p1}\mathbin{\$}\Varid{outSList}\;\Varid{x}))\mathrel{=}{}\<[E]%
\\
\>[37]{}\hsindent{2}{}\<[39]%
...
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\Varid{g}\;([\mskip1.5mu \mskip1.5mu],\Varid{t})\mathrel{=}i_1\;(\Varid{t});{}\<[E]%
\\
\>[B]{}\hsindent{8}{}\<[8]%
\>[8]{}\Varid{g}\;(\Varid{p}\mathbin{:}\Varid{ps},\Varid{t})\mathrel{=}i_2\;(\Varid{singl}\;\Varid{p},\Varid{singl}\;(\Varid{ps},\Varid{t})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{conquer2}\mathrel{=}\Varid{inBTree}\comp \alt{\Varid{outBTree}}{i_2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{divide2}\;(\Conid{Just}\;\Varid{a},\Conid{Empty})\mathrel{=}i_1\;(\Conid{Node}\;(\Varid{a},(\Conid{Empty},\Conid{Empty}))){}\<[E]%
\\
\>[B]{}\Varid{divide2}\;(\Conid{Just}\;\Varid{a},\Conid{Node}\;(\Varid{n},(\Varid{t1},\Varid{t2})))\mid \Varid{a}\leq \Varid{n}\mathrel{=}i_2\;(\Varid{n},((\Conid{Just}\;\Varid{a},\Varid{t1}),(\Conid{Nothing},\Varid{t2}))){}\<[E]%
\\
\>[B]{}\hsindent{34}{}\<[34]%
\>[34]{}\mid \Varid{a}\mathbin{>}\Varid{n}\mathrel{=}i_2\;(\Varid{n},((\Conid{Nothing},\Varid{t1}),(\Conid{Just}\;\Varid{a},\Varid{t2}))){}\<[E]%
\\
\>[B]{}\Varid{divide2}\;(\Conid{Nothing},\Varid{p})\mathrel{=}i_1\;(\Varid{p});{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{splay1}\;(\Conid{True},\Varid{l})\mathrel{=}\Varid{rrot}\comp \Varid{l}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{test}\;(\text{\ttfamily \char34 d\char34},\text{\ttfamily \char34 g\char34})\mathrel{=}\text{\ttfamily \char34 k\char34};{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
