...
\\[\blanklineskip]%
\>[B]{}\Varid{baseBdt}\;\Varid{f}\;\Varid{g}\;\Varid{h}\mathrel{=}\Varid{f}+(\Varid{g}\times(\Varid{h}\times\Varid{h})){}\<[42]%
\>[42]{}\mbox{\onelinecomment  bifunctor}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recBdt}\;\Varid{f}\mathrel{=}\Varid{id}+(\Varid{id}\times(\Varid{f}\times\Varid{f})){}\<[43]%
\>[43]{}\mbox{\onelinecomment  F f = B(id,id,f) -- lei 47}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataBdt}\;\Varid{g}\mathrel{=}\Varid{g}\comp (\Varid{recBdt}\;(\Varid{cataBdt}\;\Varid{g}))\comp \Varid{outBdt}\mbox{\onelinecomment  (\ensuremath{\Varid{g}}) = g . F (\ensuremath{\Varid{g}}) . out -l lei  44 + iso in/out}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\ana{\Varid{g}}\mathrel{=}\Varid{inBdt}\comp (\Varid{recBdt}\;\ana{\Varid{g}})\comp \Varid{g}{}\<[45]%
\>[45]{}\mbox{\onelinecomment  [(g)] = in . F[(g)] . g -- lei 53 + iso in/out}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{navLTree}\mathrel{=}\Varid{cataLTree}\;\alt{\underline{\cdot }\comp \Conid{Leaf}}{\lambda (\Varid{l},\Varid{r})\to \Varid{\Conid{Cp}.cond}\;\Varid{null}\;(\Conid{Fork}\comp \conj{\Varid{l}}{\Varid{r}})\;(\Varid{\Conid{Cp}.cond}\;\Varid{head}\;(\Varid{l}\comp \Varid{tail})\;(\Varid{r}\comp \Varid{tail}))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{navLTreePointWise}\mathbin{::}\mathsf{LTree}\;\Varid{a}\to ([\mskip1.5mu \Conid{Bool}\mskip1.5mu]\to \mathsf{LTree}\;\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{navLTreePointWise}\mathrel{=}\Varid{cataLTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{bnavLTree}\mathrel{=}\Varid{cataLTree}\;\alt{\underline{\cdot }\comp \Conid{Leaf}}{\lambda (\Varid{l},\Varid{r})\to \Varid{\Conid{Cp}.cond}\;(\Conid{Empty}\equiv )\;(\Conid{Fork}\comp \conj{\Varid{l}}{\Varid{r}})\;(\Varid{\Conid{Cp}.cond}\;(\p1\comp \Varid{outNode})\;(\Varid{l}\comp \p1\comp \p2\comp \Varid{outNode})\;(\Varid{r}\comp \p2\comp \p2\comp \Varid{outNode}))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{bnavLTreePointWise}\mathrel{=}\Varid{cataLTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\lambda \Varid{a}\;\anonymous \to \Conid{Leaf}\;\Varid{a}}{\Varid{f}}\;\mathbf{where}{}\<[E]%
\\
...
\\
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}\Varid{f}\;(\Varid{l},\Varid{r})\;\Conid{Empty}\mathrel{=}\Varid{unfoldD}\;(\Conid{D}\;[\mskip1.5mu (\Varid{l}\;\Conid{Empty},\mathrm{0.5}),(\Varid{r}\;\Conid{Empty},\mathrm{0.5})\mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{10}{}\<[13]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{arvoreDist}\mathrel{=}(\Conid{Node}\;((\Conid{D}\;[\mskip1.5mu (\Conid{True},\mathrm{0.7}),(\Conid{False},\mathrm{0.3})\mskip1.5mu]),((\Conid{Node}\;((\Conid{D}\;[\mskip1.5mu (\Conid{True},\mathrm{0.6}),(\Conid{False},\mathrm{0.4})\mskip1.5mu]),(\Conid{Empty},\Conid{Empty}))),\Conid{Empty}))){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{testProb}\;(\Conid{Leaf}\;\Varid{a})\;\anonymous \mathrel{=}\Conid{D}\;[\mskip1.5mu (\Conid{Leaf}\;\Varid{a},\mathrm{1})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{testProb}\;(\Conid{Fork}\;(\Varid{t1},\Varid{t2}))\;\Conid{Empty}\mathrel{=}\Varid{unfoldD}\;(\Conid{D}\;[\mskip1.5mu ((\Varid{testProb}\;\Varid{t1}\;\Conid{Empty}),\mathrm{0.5}),((\Varid{testProb}\;\Varid{t2}\;\Conid{Empty}),\mathrm{05})\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{testProb}\;(\Conid{Fork}\;(\Varid{t1},\Varid{t2}))\;(\Conid{Node}\;(\Varid{d},(\Varid{b1},\Varid{b2})))\mathrel{=}\Varid{\Conid{Probability}.cond}\;\Varid{d}\;(\Varid{testProb}\;\Varid{t1}\;\Varid{b1})\;(\Varid{testProb}\;\Varid{t2}\;\Varid{b2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
