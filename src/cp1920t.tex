...
\\
\>[B]{}\Varid{dic\char95 rd}\;\Varid{s}\;\Varid{d}\mathrel{=}\Varid{while2}\;\Varid{p}\;\Varid{loopBody}\;\Varid{exit}\;(\Varid{s},\Conid{Just}\;\Varid{d}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{p}\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{a}\not\equiv [\mskip1.5mu \mskip1.5mu]\mathrel{\wedge}\Varid{isJust}\;\Varid{b}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{exit}\;(\anonymous ,\Conid{Nothing})\mathrel{=}\Conid{Nothing}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{exit}\;([\mskip1.5mu \mskip1.5mu],\Conid{Just}\;(\Conid{Var}\;\Varid{x}))\mathrel{=}\Conid{Just}\;[\mskip1.5mu \Varid{x}\mskip1.5mu]{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{exit}\;([\mskip1.5mu \mskip1.5mu],\Conid{Just}\;(\Conid{Term}\;\Varid{o}\;\Varid{l})){}\<[E]%
\\
\>[9]{}\hsindent{2}{}\<[11]%
\>[11]{}\mid \Varid{otherwise}\mathrel{=}\Varid{f}\;\Varid{l}{}\<[E]%
\\
\>[9]{}\hsindent{2}{}\<[11]%
\>[11]{}\mathbf{where}\;\Varid{f}\mathrel{=}\alt{\Varid{nothing}}{\Conid{Just}\comp \Varid{cons}}\comp \Varid{outList}\comp \map \;\alt{\Varid{id}}{\p1}\comp \Varid{filter}\;(\Varid{isLeft})\comp \map \;(\Varid{outExp}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{29}{}\<[29]%
\>[29]{}\mid (\Varid{head}\;\Varid{s}\equiv \Varid{head}\;\Varid{o})\mathrel{=}(\Varid{tail}\;\Varid{s},\Conid{Just}\;(\Conid{Term}\;\Varid{o}\;\Varid{l})){}\<[E]%
\\
\>[B]{}\hsindent{29}{}\<[29]%
\>[29]{}\mid \Varid{otherwise}\mathrel{=}(\Varid{s},\Varid{termLsearch}\;\Varid{s}\;\Varid{l}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{dic\char95 in}\;\Varid{p}\;\Varid{t}\;\Varid{d}\mathrel{=}\Varid{dic\char95 in\char95 aux}\;(\Conid{Just}\;(\Varid{traductionToDict}\;(\Varid{p},\Varid{t})),\Varid{d}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dic\char95 in\char95 aux}\mathbin{::}(\Conid{Maybe}\;(\Conid{Dict}),\Conid{Dict})\to \Conid{Dict}{}\<[E]%
\\
\>[B]{}\Varid{dic\char95 in\char95 aux}\mathrel{=}\Varid{anaExp}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\;(\anonymous ,\Conid{Var}\;\Varid{v})\mathrel{=}i_1\;(\Varid{v}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g}\;(\Conid{Just}\;(\Conid{Term}\;\Varid{a}\;\Varid{b}),\Conid{Term}\;\Varid{o}\;\Varid{l}){}\<[38]%
\>[38]{}\mid (\Varid{o}\equiv [\mskip1.5mu \mskip1.5mu]\mathrel{\vee}\Varid{o}\equiv \text{\ttfamily \char34 ~\char34})\mathrel{=}\Varid{recExp}\;\conj{\underline{(\Conid{Just}\;(\Conid{Term}\;\Varid{a}\;\Varid{b}))}}{\Varid{id}}\;{}\<[109]%
\>[109]{}(\Varid{outExp}\;(\Conid{Term}\;\Varid{o}\;(\Varid{insertIfAbsent}\;(\Conid{Term}\;\Varid{a}\;\Varid{b},\Varid{l})))){}\<[E]%
\\
\>[9]{}\hsindent{5}{}\<[14]%
\>[14]{}\mid (\Varid{head}\;\Varid{o}\equiv \Varid{head}\;\Varid{a})\mathrel{=}{}\<[38]%
\>[38]{}\Varid{recExp}\;\conj{\underline{(\Conid{Just}\;(\Varid{head}\;\Varid{b}))}}{\Varid{id}}\;{}\<[81]%
\>[81]{}(\Varid{outExp}\;(\Conid{Term}\;\Varid{o}\;(\Varid{insertIfAbsent}\;(\Varid{head}\;\Varid{b},\Varid{l})))){}\<[E]%
\\
\>[9]{}\hsindent{5}{}\<[14]%
\>[14]{}\mid \Varid{otherwise}\mathrel{=}\Varid{recExp}\;\conj{\Varid{nothing}}{\Varid{id}}\;{}\<[55]%
\>[55]{}(\Varid{outExp}\;(\Conid{Term}\;\Varid{o}\;\Varid{l})){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g}\;(\Conid{Nothing},\Varid{v})\mathrel{=}{}\<[26]%
\>[26]{}\Varid{recExp}\;\conj{\Varid{nothing}}{\Varid{id}}\;(\Varid{outExp}\;\Varid{v}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin 
insertIfPresent :: (Dict,[Dict]) -> [Dict]
insertIfPresent = hyloSList f g
  where g (Term a b, ((Term o l):ds)) \ensuremath{(\Varid{head}\;\Varid{a}\equiv \Varid{head}\;\Varid{o})\mathrel{=}i_1\;((\Conid{Term}\;\Varid{o}\;\Varid{l})\mathbin{:}\Varid{ds})} otherwise = i2(Term o l, (Term a b, ds))
        g (l, (Var x):ds) = i2 (Var x, (l,ds))
        g (l,[]) = i1(singl l)
        f = either id cons \commentend}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{insertIfAbsent}\;((\Conid{Term}\;\Varid{o}\;\Varid{l}),((\Conid{Term}\;\Varid{a}\;\Varid{b})\mathbin{:}\Varid{ts}))\mathrel{=}\mathbf{if}\;(\Varid{head}\;\Varid{o}\equiv \Varid{head}\;\Varid{a})\;\mathbf{then}\;((\Conid{Term}\;\Varid{a}\;\Varid{b})\mathbin{:}\Varid{ts})\;\mathbf{else}\;(\Conid{Term}\;\Varid{a}\;\Varid{b})\mathbin{:}(\Varid{insertIfAbsent}\;((\Conid{Term}\;\Varid{o}\;\Varid{l}),\Varid{ts})){}\<[E]%
\\
\>[B]{}\Varid{insertIfAbsent}\;((\Conid{Term}\;\Varid{o}\;\Varid{l}),[\mskip1.5mu \mskip1.5mu])\mathrel{=}{}\<[35]%
\>[35]{}[\mskip1.5mu (\Conid{Term}\;\Varid{o}\;\Varid{l})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{insertIfAbsent}\;(\Varid{l},(\Varid{t}\mathbin{:}\Varid{ts}))\mathrel{=}\Varid{t}\mathbin{:}(\Varid{insertIfAbsent}\;(\Varid{l},\Varid{ts})){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{nothing}}{(\bind )\;(\p2\comp \p2)\;\Varid{return}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{nothing}}{\Varid{f}}{}\<[E]%
\\
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}\mathbf{where}\;\Varid{f}\;(\Varid{a},(\Conid{Nothing},\Varid{t2}))\mathrel{=}\Varid{return}\;\Varid{a}{}\<[E]%
\\
\>[13]{}\hsindent{6}{}\<[19]%
\>[19]{}\Varid{f}\;(\Varid{a},(\Varid{t1},\Varid{t2}))\mathrel{=}\Varid{t1}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\fun{BTree} \;\Conid{X}}
           \ar[d]_-{\ensuremath{\Varid{cataBTree}\;(\Varid{g})}}
           \ar[r]_-{\ensuremath{\Varid{outBTree}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{X}\times(\fun{BTree} \;\Conid{X})\;^2)}
           \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}(\Varid{recBTree}\;(\Varid{cataBTree}\;(\Varid{g}))}}
\\
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{X}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{X}\times\fun{BTree} \;\Conid{X}}
           \ar[l]^-{g}
}
\end{eqnarray*}
...
\\[\blanklineskip]%
\>[B]{}\Varid{insOrd}\;\Varid{a}\;\Varid{x}\mathrel{=}\Varid{anaBTree}\;\Varid{f}\;(\Conid{Just}\;\Varid{a},\Varid{x}){}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mathbf{where}\;\Varid{f}\;(\Conid{Nothing},\Conid{Empty})\mathrel{=}i_1\;(){}\<[E]%
\\
\>[13]{}\hsindent{6}{}\<[19]%
\>[19]{}\Varid{f}\;(\Conid{Just}\;\Varid{a},\Conid{Empty})\mathrel{=}i_2\;(\Varid{a},((\Conid{Nothing},\Conid{Empty}),(\Conid{Nothing},\Conid{Empty}))){}\<[E]%
\\
\>[13]{}\hsindent{6}{}\<[19]%
\>[19]{}\Varid{f}\;(\Conid{Just}\;\Varid{a},\Conid{Node}\;(\Varid{x},(\Varid{t1},\Varid{t2})))\mid \Varid{a}\leq \Varid{x}\mathrel{=}i_2\;(\Varid{x},((\Conid{Just}\;\Varid{a},\Varid{t1}),(\Conid{Nothing},\Varid{t2}))){}\<[E]%
\\
\>[19]{}\hsindent{28}{}\<[47]%
\>[47]{}\mid \Varid{otherwise}\mathrel{=}i_2\;(\Varid{x},((\Conid{Nothing},\Varid{t1}),(\Conid{Just}\;\Varid{a},\Varid{t2}))){}\<[E]%
\\
\>[13]{}\hsindent{6}{}\<[19]%
\>[19]{}\Varid{f}\;(\Conid{Nothing},\Conid{Node}\;(\Varid{x},(\Varid{t1},\Varid{t2})))\mathrel{=}i_2\;(\Varid{x},((\Conid{Nothing},\Varid{t1}),(\Conid{Nothing},\Varid{t2}))){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{isOrd}\mathrel{=}\p1\comp \Varid{cataBTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
...
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{f}\mathrel{=}(\Varid{id}\times(\p2\times\p2))\mbox{\onelinecomment (a, (Bool, BTree a), (Bool, BTree a)) -> (a,BTree a, BTree a)}{}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{splay}\mathrel{=}\Varid{cataList}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\\
\>[B]{}\mbox{\commentbegin             f _ Empty = Empty
        f (b1,b2) (Node (a,(t1,t2))) = if b1 then b2 t1 else b2 t2 \commentend}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{recBdt}\;\Varid{f}\mathrel{=}\Varid{id}+(\Varid{id}\times(\Varid{f}\times\Varid{f})){}\<[E]%
\\[\blanklineskip]%
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{y}\mathrel{=}\Conid{Node}\;(\Conid{True},(\Conid{Node}\;(\Conid{True},(\Conid{Empty},\Conid{Empty})),\Conid{Empty})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outNode}\;(\Conid{Node}\;(\Varid{a},(\Varid{b},\Varid{c})))\mathrel{=}(\Varid{a},(\Varid{b},\Varid{c})){}\<[E]%
\\[\blanklineskip]%
...
\>[13]{}\Varid{f}\;(\Varid{l},\Varid{r})\;(\Conid{Node}\;(\Varid{d},(\Varid{b1},\Varid{b2})))\mathrel{=}\Varid{\Conid{Probability}.cond}\;\Varid{d}\;(\Varid{l}\;\Varid{b1})\;(\Varid{r}\;\Varid{b2}){}\<[E]%
\\
\>[B]{}\Varid{xxx}\;(\Varid{l},\Varid{r})\;\Conid{Empty}\mathrel{=}(\Varid{prod}\;(\Varid{l}\;\Conid{Empty})\;(\Varid{r}\;\Conid{Empty}))\bind (\Varid{return}\comp \Conid{Fork}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{x}\mathrel{=}\Conid{Fork}\;(\Conid{Leaf}\;\text{\ttfamily \char34 Precisa\char34},\Conid{Fork}\;(\Conid{Leaf}\;\text{\ttfamily \char34 Precisa\char34},\Conid{Leaf}\;\text{\ttfamily \char34 N~precisa\char34})){}\<[E]%
\\
\>[B]{}\Varid{z}\mathrel{=}\Conid{Node}\;(\Conid{D}\;[\mskip1.5mu (\Conid{True},\mathrm{0.6}),(\Conid{False},\mathrm{0.4})\mskip1.5mu],(\Conid{Empty},\Conid{Empty})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{anita}\mathrel{=}\Conid{Query}\;(\text{\ttfamily \char34 2a~feira?\char34},(\Conid{Query}\;(\text{\ttfamily \char34 chuva~na~ida\char34},(\Conid{Dec}\;\text{\ttfamily \char34 precisa\char34},\Conid{Query}\;(\text{\ttfamily \char34 chuva~no~regresso?\char34},(\Conid{Dec}\;\text{\ttfamily \char34 precisa\char34},\Conid{Dec}\;\text{\ttfamily \char34 nao~precisa\char34})))),\Conid{Dec}\;\text{\ttfamily \char34 nao~precisa\char34})){}\<[E]%
\\
\>[B]{}\Varid{testePaulo1}\mathrel{=}\Varid{extLTree}\;\Varid{anita}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{btreePaulo}\mathrel{=}\Conid{Node}\;(\Conid{D}\;[\mskip1.5mu (\Conid{True},\mathrm{0.8}),(\Conid{False},\mathrm{0.2})\mskip1.5mu],(\Conid{Empty},\Conid{Empty})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{testHenrique}\mathrel{=}\Conid{Pictures}\;[\mskip1.5mu \Conid{Translate}\;\mathrm{0.0}\;\mathrm{0.0}\;(\Conid{Pictures}\;[\mskip1.5mu \Conid{Translate}\;\mathrm{0.0}\;\mathrm{80.0}\;(\Conid{Arc}\;(\mathbin{-}\mathrm{90.0})\;\mathrm{0.0}\;\mathrm{40.0}),\Conid{Translate}\;\mathrm{80.0}\;\mathrm{0.0}\;(\Conid{Arc}\;\mathrm{90.0}\;\mathrm{180.0}\;\mathrm{40.0})\mskip1.5mu]),\Conid{Translate}\;\mathrm{0.0}\;\mathrm{80.0}\;(\Conid{Pictures}\;[\mskip1.5mu \Conid{Translate}\;\mathrm{0.0}\;\mathrm{80.0}\;(\Conid{Arc}\;(\mathbin{-}\mathrm{90.0})\;\mathrm{0.0}\;\mathrm{40.0}),\Conid{Translate}\;\mathrm{80.0}\;\mathrm{0.0}\;(\Conid{Arc}\;\mathrm{90.0}\;\mathrm{180.0}\;\mathrm{40.0})\mskip1.5mu]),\Conid{Translate}\;\mathrm{80.0}\;\mathrm{0.0}\;(\Conid{Pictures}\;[\mskip1.5mu \Conid{Translate}\;\mathrm{0.0}\;\mathrm{0.0}\;(\Conid{Arc}\;\mathrm{0.0}\;\mathrm{90.0}\;\mathrm{40.0}),\Conid{Translate}\;\mathrm{80.0}\;\mathrm{80.0}\;(\Conid{Arc}\;\mathrm{180.0}\;(\mathbin{-}\mathrm{90.0})\;\mathrm{40.0})\mskip1.5mu]),\Conid{Translate}\;\mathrm{80.0}\;\mathrm{80.0}\;(\Conid{Pictures}\;[\mskip1.5mu \Conid{Translate}\;\mathrm{0.0}\;\mathrm{0.0}\;(\Conid{Arc}\;\mathrm{0.0}\;\mathrm{90.0}\;\mathrm{40.0}),\Conid{Translate}\;\mathrm{80.0}\;\mathrm{80.0}\;(\Conid{Arc}\;\mathrm{180.0}\;(\mathbin{-}\mathrm{90.0})\;\mathrm{40.0})\mskip1.5mu])\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{put}{}\<[6]%
\>[6]{}\mathrel{=}\uncurry{\Conid{Translate}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{final}\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{r}\leftarrow \Varid{generateMatrix}\;\mathrm{10}\;\mathrm{10}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\>[23]{}(\Varid{sequence}\comp \Varid{replicate}\;(\Varid{i}\mathbin{*}\Varid{j})\mathbin{\$}\Varid{randomRIO}\;(\mathrm{0},\mathrm{1})\bind \Varid{generateTruchet})\bind (\Varid{return}\comp \Varid{pictures}\comp \Varid{zipWith}\;\Varid{id}\;\Varid{l}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{l}\mathrel{=}\mathbf{do}\;\{\mskip1.5mu \Varid{x'}\leftarrow \map \;(\mathrm{80}\mathbin{*})\;[\mskip1.5mu \mathrm{0}\mathinner{\ldotp\ldotp}(\Varid{fromIntegral}\;\Varid{i})\mathbin{-}\mathrm{1}\mskip1.5mu];\Varid{y'}\leftarrow \map \;(\mathrm{80}\mathbin{*})\;[\mskip1.5mu \mathrm{0}\mathinner{\ldotp\ldotp}(\Varid{fromIntegral}\;\Varid{j})\mathbin{-}\mathrm{1}\mskip1.5mu];\Varid{return}\;(\Varid{put}\;(\Varid{x'},\Varid{y'}))\mskip1.5mu\}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{generateTruchet}\;\Varid{x}\mathrel{=}\Varid{return}\comp \alt{\underline{\Varid{truchet1}}}{\underline{\Varid{truchet2}}}\mathbin{\$}\Varid{outNat}\mathbin{\$}\Varid{fromInteger}\;\Varid{x}{}\<[E]%
\\[\blanklineskip]%
