...
\\[\blanklineskip]%
\>[B]{}\Varid{cataBdt}\;\Varid{gene}\mathrel{=}\Varid{gene}\comp (\Varid{recBdt}\;(\Varid{cataBdt}\;\Varid{gene}))\comp \Varid{outBdt}\mbox{\onelinecomment  (\ensuremath{\Varid{g}}) = g . F (\ensuremath{\Varid{g}}) . out -l lei  44 + iso in/out}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\ana{\Varid{gene}}\mathrel{=}\Varid{inBdt}\comp (\Varid{recBdt}\;\ana{\Varid{gene}})\comp \Varid{gene}{}\<[54]%
\>[54]{}\mbox{\onelinecomment  [(g)] = in . F[(g)] . g -- lei 53 + iso in/out}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{navLTree2}\mathbin{::}\mathsf{LTree}\;\Varid{a}\to ([\mskip1.5mu \Conid{Bool}\mskip1.5mu]\to \mathsf{LTree}\;\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{navLTree2}\mathrel{=}\Varid{cataLTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{bnavLTree}\mathrel{=}\Varid{cataLTree}\;\alt{\underline{\cdot }\comp \Conid{Leaf}}{\lambda (\Varid{l},\Varid{r})\to \Varid{\Conid{Cp}.cond}\;(\Conid{Empty}\equiv )\;(\Conid{Fork}\comp \conj{\Varid{l}}{\Varid{r}})\;(\Varid{\Conid{Cp}.cond}\;\p1\;(\Varid{l}\comp \p1\comp \p2)\;(\Varid{r}\comp \p2\comp \p2))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{bnavLTree2}\mathrel{=}\Varid{cataLTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\lambda \Varid{a}\;\anonymous \to \Conid{Leaf}\;\Varid{a}}{\Varid{f}}\;\mathbf{where}{}\<[E]%
\\
