...
\\
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}\Varid{f}\;(\Varid{l},\Varid{r})\;{}\<[23]%
\>[23]{}[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{Fork}\;(\Varid{l}\;[\mskip1.5mu \mskip1.5mu],\Varid{r}\;[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}\Varid{f}\;(\Varid{l},\Varid{r})\;{}\<[23]%
\>[23]{}(\Conid{True}\mathbin{:}\Varid{hs})\mathrel{=}\Varid{l}\;\Varid{hs}{}\<[E]%
\\
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}\Varid{f}\;(\Varid{l},\Varid{r})\;{}\<[23]%
\>[23]{}(\Conid{False}\mathbin{:}\Varid{hs})\mathrel{=}\Varid{r}\;\Varid{hs}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}\Varid{f}\;(\Varid{l},\Varid{r})\;{}\<[23]%
\>[23]{}\Conid{Empty}\mathrel{=}\Conid{Fork}\;(\Varid{l}\;\Conid{Empty},\Varid{r}\;\Conid{Empty}){}\<[E]%
\\
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}\Varid{f}\;(\Varid{l},\Varid{r})\;{}\<[23]%
\>[23]{}(\Conid{Node}\;(\Conid{True},(\Varid{left},\Varid{right})))\mathrel{=}\Varid{l}\;\Varid{left}{}\<[E]%
\\
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}\Varid{f}\;(\Varid{l},\Varid{r})\;{}\<[23]%
\>[23]{}(\Conid{Node}\;(\Conid{False},(\Varid{left},\Varid{right})))\mathrel{=}\Varid{r}\;\Varid{right}{}\<[E]%
\\[\blanklineskip]%
